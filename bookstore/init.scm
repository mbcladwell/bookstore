...
(define (init-db-json db-dir)
  ...
  (let* ((tags1 #("mytag1" "mytag2" "mytag3"))
	 ...
	 (book2 `(("title" . "mytitle2")("author" . #("Plain Jane" "Julie Jilly"))("fname" . "mytitle1")("hash" . "5678")("ext" . "txt")("tags" . ,tags2)))
	 (book3 `(("title" . "mytitle3")("author" . #("Bill Barr" "Sam Hyde"))("fname" . "mytitle1")("hash" . "9012")("ext" . "txt")("tags" . ,tags2)))
	 (book4 `(("title" . "mytitle4")("author" . #("Chuck Chew" "Paul Watson"))("fname" . "mytitle1")("hash" . "5378")("ext" . "txt")("tags" . ,tags3)))
	 (book5 `(("title" . "mytitle5")("author" . #("Don Dee" "Dennis Hopper"))("fname" . "mytitle1")("hash" . "9836")("ext" . "txt")("tags" . ,tags3)))
	 (book6 `(("title" . "mytitle6")("author" . #("Paul Poop" "Thelonius Monk"))("fname" . "mytitle1")("hash" . "4523")("ext" . "txt")("tags" . ,tags3)))
